...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ReactInterval = __webpack_require__(162);
	
	var _ReactInterval2 = _interopRequireDefault(_ReactInterval);
	
	var _package = __webpack_require__(163);
	...
	var App = _react2.default.createClass({
	  ...
	  inc10: function inc10() {
	    var count = this.state.count;
	
	    this.setState({ count: count + 10 });
	  },
	  onChangeTimeout: function onChangeTimeout(_ref) {
	    var value = _ref.target.value;
	
	    this.setState({ timeout: parseInt(value, 10) });
	  },
	  onToggleInterval: function onToggleInterval() {
	    var enabled = this.state.enabled;
	
	    this.setState({ enabled: !enabled });
	  },
	  onToggleDestroy: function onToggleDestroy() {
	    var destroy = this.state.destroy;
	
	    this.setState({ destroy: !destroy });
	  },
	  onToggleCallback: function onToggleCallback() {
	  ...
	  render: function render() {
	    ...
	    var destroy = _state.destroy;
	    var callback = _state.callback;
	    var timeout = _state.timeout;
	    var enabled = _state.enabled;
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        destroy ? null : _react2.default.createElement(_ReactInterval2.default, { timeout: timeout, enabled: enabled, callback: callback }),
